...
namespace general_physics
{
	...
	*/
	...
	float magnetic_force(float particle_charge, float particle_velocity, float magnetic_field_strength, float angle_between_velocity_and_field) 
	{
	...
	{
		return -magnetic_field * distance_between_electrodes * liquid_velocity;
	}
	
	float magnetic_h_field(float magnetic_field, float magnetization_vector)
	{
		return VACUUM_PERMEABILITY_CONSTANT * magnetic_field - magnetization_vector;
	}
}
